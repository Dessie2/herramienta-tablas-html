...
export default function HtmlPlayground({ initialHtml = "" }) {
  ...
  return (
    <div className="w-full min-w-0 rounded-xl border-2 border-azul/10 shadow-[6px_6px_0px_rgba(0,0,0,0.12)] overflow-hidden bg-white">
      <div className="grid grid-cols-1 md:grid-cols-2 min-h-[320px] sm:min-h-[480px] md:min-h-[620px]">
        <div className="flex flex-col min-h-[200px] sm:min-h-[280px] md:min-h-0 border-b md:border-b-0 md:border-r border-azul/10">
          ...
          <textarea
            ...
            className="flex-1 w-full min-h-[180px] sm:min-h-[240px] p-3 sm:p-4 font-mono text-xs sm:text-sm leading-relaxed text-[#7dbe6c] bg-[#1e1e1e] resize-none outline-none placeholder:text-slate-500"
          />
        </div>

        <div className="flex flex-col min-h-[200px] sm:min-h-[280px] md:min-h-0">
