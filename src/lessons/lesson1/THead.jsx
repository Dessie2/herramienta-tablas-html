...
export default function THead() {
  ...
  return (
    <LessonLayout title="Etiqueta &lt;thead&gt;">
      <div className="lesson-content-panel bg-blanco w-full min-h-[500px] rounded-md shadow-md p-6 sm:p-10 flex flex-col flex-1">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-10 flex-1 min-w-0">
          <div className="flex flex-col text-lg sm:text-xl lg:text-2xl max-w-2xl">
            <p>
              La etiqueta <span className="font-bold text-amarillo">&lt;thead&gt;</span> podría ser confundida
...
<table border="1">`}<span className="text-amarillo">{`
<thead>`}</span>{`
  <tr>
    <th>Encabezado 1</th>
    <th>Encabezado 2</th>
  ...
  <tr>
    ...
    <td>Celda A2</td>
        ...
        <div className="flex justify-end mt-auto pt-4">
          <button
            onClick={() => navigate("/lessons/lesson1/Thead_more")}
